		...
		function doMove (num){
        	...
        	//options选项卡切换
        	(function(){
        		tnTab($('.tabNav1'),$('.tabCon1'),'click');
        		tnTab($('.tabNav2'),$('.tabCon2'),'click');
        		tnTab($('.tabNav3'),$('.tabCon3'),'click');
        		tnTab($('.tabNav4'),$('.tabCon4'),'click');
        		
        		function tnTab(oNav,aCon,sEvent){
		...
		$('.hot_area li').mouseover(function(){
			...
			$(this).append('<p style="width:'+($(this).width()-12)+'px;height:'+($(this).height()-2)+'px;">'+arr[$(this).index()]+'</p>');
		})
        	})();
        });
